...
$(function () {
    ...
    function _0x2f11x3() {
        ...
        $[_0x4027[33]]({
            ...
            dataType: _0x4027[13],
            url: _0x4027[14],
            data: { domain: wokiee_app[_0x4027[5]][_0x4027[6]], lic: wokiee_app[_0x4027[5]][_0x4027[7]], url: wokiee_app[_0x4027[5]][_0x4027[8]], themeId: _0x4027[15] },
            cache: false,
                ...
                if (_0x2f11x5[_0x4027[16]] == _0x4027[17] || _0x2f11x5[_0x4027[16]] == _0x4027[18]) {
                    try {
                        if ($[_0x4027[2]](_0x4027[1]) != _0x4027[3]) {
                            ...
                            $[_0x4027[2]](_0x4027[1], _0x4027[3], { expires: _0x2f11x6, path: _0x4027[21] });
                        }
                    } catch (err) {}
                    return false;
                }
...
function mm_destroy(e, m) {
    m.remember_state || (e.find(".mmpanel").toggleClass("mmsubopened mmcurrent mmopened", !1).addClass("mmhidden"), e.find("#mm0").addClass("mmopened").addClass("mmcurrent").removeClass("mmhidden")),
            ...
            n.find("ul").each(function (m) {
                (i = !1),
                    (a = $(get_mm_block())
                        ...
                        .append($(this))),
                    0 == m
                        ? (a.addClass("mmopened").addClass("mmcurrent").removeClass("mmhidden"), (i = getButtonClose(n.find(".mm-closebtn").html(), e.mm_close_button)), a.find("ul").first().prepend(i))
                        : ((i = getButtonBack(n.find(".mm-backbtn").html(), e.mm_back_button)), a.find("ul").first().prepend(i)),
                    t.append(a);
            }),
            $(this).append(t);
    }),
    ...
    switch (t) {
        ...
        case "getGroupHtml":
            return (
                ...
                e.title +
                ': <span class="current_option_name"></span></div><ul class="yoo_options_swatch tt-options-swatch options-large">' +
                e.html +
                "</ul></div>"
            );
        case "getButtonHtml":
            ...
            var f =
                "" != s
                    ? "<li" + i + ">" + d + '<a href="#" onClick="setTimeout(getCurrentvariantclass, 500)" class="options-color"' + r + '" data-value="' + o + '"  data-background-image="' + e.texture[o] + '"  data-tooltip="' + o + '" ' + s + "></a></li>"
                    : "<li" + i + '><a href="#" data-value=' + p + ">" + o + "</a></li>";
            return e.value == e.selected && a ? f.replace(/<li/, '<li class="active yooColor"') : f;
...
var addToCartHandler = {
    ...
    updateGeneralInfo: function (cart) {
		...
		if(cart.item_count > 9){
			_parent.find(".tt-badge-cart").text("_"+cart.item_count);
		}
		else
		{
			_parent.find(".tt-badge-cart").text("_0"+cart.item_count);
		}
...
removeFromCartHandler();
      ...
      function getCurrentvariantclass(){
	...
	var ypp_imagest = [];
		$(".ypp_images").each(function() {
          
       
          
	    ypp_imagest.push($(this).attr('data-image'));
	});
        
       var ypp_imagest_ln = ypp_imagest.length;
        ...
        for (let a of ypp_imagest) {
    	
       
          
          if(o == 0){
           
            var coIm = '<div class="item active"><img src="'+a+'"></div>';
            
          } else {
          
          var coIm = '<div class="item "><img src="'+a+'"></div>';
          ...
          var coIm = '<div class="item active"><img src="'+bg+'"></div>';
          $(".carousel-inner").append(coIm);    
        ...
        var bg = jQuery("li.active.yooColor a").attr('data-background-image');
        
        var bg = bg.replace("_100x", "");
        
     
      	
        $('.item.active img').attr("src",bg);
 ...
 alert("1");
  $("li.yooColor").click(function() {
   //var colorClass = this.className;
  // console.log(colorClass);
    alert("2");
   // var bg = jQuery(".yooColor a").css('background-image');
...
function updateCheckoutURL(){
    fetch("https://ipwhois.app/json/?lang=en").then((response) => response.text()).then((responseText) => {
        ...
        if(country_code){
            updatecartURL(country_code)
        }else{
            $.get("https://ipinfo.io", function(response) {
                updatecartURL(response.country);
            }, "jsonp");
        }
    });
}

function updatecartURL(country_code){
